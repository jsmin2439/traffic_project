...
plots.plot_node_channel_heatmap(
    results_dict={
        'lstm':   {'preds': results_dict['lstm']['preds_orig'],
                   'trues': results_dict['lstm']['trues_orig']},
        'stgcn':  {'preds': results_dict['stgcn']['preds_orig'],
                   'trues': results_dict['stgcn']['trues_orig']},
        'resstgcn': {'preds': results_dict['resstgcn']['preds_orig'],
                    'trues': results_dict['resstgcn']['trues_orig']}
    },
